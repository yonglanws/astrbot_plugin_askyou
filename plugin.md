...
- [开发环境准备](#开发环境准备)
  - [获取插件模板](#获取插件模板)
  - [Clone 插件和 AstrBot 项目](#clone-插件和-astrbot-项目)
  - [调试插件](#调试插件)
  - [插件依赖管理](#插件依赖管理)
- [提要](#提要)
  - [最小实例](#最小实例)
...
- [开发指南](#开发指南)
  ...
  - [AI](#ai)
    - [通过提供商调用 LLM](#通过提供商调用-llm)
    - [获取其他类型的提供商](#获取其他类型的提供商)
    - [函数工具](#函数工具)
      - [以类的形式](#以类的形式)
      - [以装饰器的形式](#以装饰器的形式)
    - [对话管理器 ConversationManager](#对话管理器-conversationmanager)
      ...
      - [`get_filtered_conversations`](#get-filtered-conversations)
      - [`update_conversation`](#update-conversation)
      - [`get_human_readable_context`](#get-human-readable-context)
    - [人格设定管理器 PersonaManager](#人格设定管理器-personamanager)
...
<a id="对话管理器-conversationmanager"></a>
#### 对话管理器 ConversationManager [​](#对话管理器-conversationmanager)
...
<a id="get-curr-conversation-id"></a>
##### `get_curr_conversation_id` [​](#get-curr-conversation-id)
...
<a id="get-filtered-conversations"></a>
##### `get_filtered_conversations` [​](#get-filtered-conversations)
...
<a id="get-human-readable-context"></a>
##### `get_human_readable_context` [​](#get-human-readable-context)
